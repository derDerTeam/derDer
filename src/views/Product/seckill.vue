        ...
        <span class="h-subTit fl"
          >有品秒杀<span class="timestr"
            ><img
              ...
              alt=""
            /><span>{{ seckillList.date }}场</span></span
          ></span
        >
          ...
          <div class="m-goods-item-container  pro-item-trap margin-left-0">
            ...
            <div class="bigtrap-box">
              ...
              <p class="pro-price">
                ...
                ><span class="m-num">{{ item.nowPrice }}</span
                ><span class="pro-flag">起</span>
                <span class="market-price"
                  ><span class="pro-unit">¥</span>
                  <span class="m-num">{{ item.oldPrice }}</span></span
                >
              </p>
            </div>
          </div>
...
export default {
  ...
  computed: {
    bannerList: {
      get() {
        return this.seckillList.children;
      },
    },
  },
  watch: {
...
.swiper-slide {
  ...
  &:hover {
    ...
    top: -2px;
    box-shadow: 10px 20px 3px 6px #eee;
  }
}
</style>
