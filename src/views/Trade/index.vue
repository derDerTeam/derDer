            ...
            <div class="clearfix list">
              <div class="address-list">
                <div class="address-item" @click="isShow = true">
                  <div class="addIcon">
                    <a
                      class="iconfont icon-iconaddaddresss"
                      data-src
                      href="javascript:;"
                    ></a>
                  </div>
                  ...
                  <!-- 弹出的添加新地址框 -->
                  <el-dialog title="添加收获地址" :visible.sync="isShow">
                    <el-form :model="form">
                      <el-input
                        v-model="form.name"
                        autocomplete="off"
              ...
              <div class="form-item no-border">
                ...
                <div class="select">
                  <div class="option-list">
                    <span class="option active">不开发票</span>
                    <span class="option">电子发票</span>
                  </div>
                </div>
              </div>
              <!-- 发票抬头 -->
        ...
        <div class="checkout-summary clearfix">
          <div class="check-freeInfo fr">
            <div class="freeInfo-item">
              ...
              <span class="freeInfo-value">元</span>
            </div>
