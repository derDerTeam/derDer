		...
		<div class="layout">
			...
			<div class="regist_list">
				<div class="regbox">
					...
					<label class="labelbox" for="">
						<div class="cycode_box" _region="CN" _def_method="PH">
							<div class="reg-phone-select-cty">
								<div class="tits">
			...
			<div class="privacy_box">
				<div class="outsideBox">
					<span>已阅读并同意：小米</span>
					<a href="https://static.account.xiaomi.com/html/agreement/user/zh_CN.html" class="inspect_link" title="用户协议"
						target="_blank">用户协议</a>
					<span>和</span>
					<a href="https://privacy.mi.com/miaccount/zh_CN/" class="inspect_link" title=" 隐私政策 " target="_blank"> 隐私政策
					</a>
				</div>
			</div>
		</div>
	...
	#content {
		...
		.external_logo_area {
			...
			.milogo {
				...
				display: block;
				cursor: default;
				background: url(../imges/milogo.png);
			}
		}
